//! Minimal SHA-256. Used to verify that a copied file matches its source.
//!
//! Hand-written so the tool has no dependencies. Correctness is pinned by the
//! published test vectors at the bottom of this file.
